...
export default function Skilltree() {
  return (
    <div className="talent-tree">
      ...
      <div className="skill has-points can-add-points" data-skill-id={1}>
      ...
      <div className="skill" data-skill-id={3}>
        ...
        <div className="tool-tip">
          ...
          <div className="skill-description">
            Preprocessors like LESS and SASS help you write more structured and
            efficient CSS by adding features like variables, functions, and
            nesting.
          </div>
          <ul className="skill-links">
            <li>
          ...
          <div className="current-rank-description" />
          <div className="next-rank-description">
            Next rank: <span>You are familiar with variables and nesting.</span>
          </div>
          <hr />
          <ul className="stats">
            <li>
      ...
      <div className="skill" data-skill-id={5}>
        ...
        <div className="tool-tip">
          ...
          <div className="skill-description">
            jQuery provides techniques and methods for client-side manipulation
            of the web page elements.
          </div>
          <ul className="skill-links">
            <li>
              <a target="_blank" href="http://www.codecademy.com/tracks/jquery">
                Codecademy jQuery
              </a>
            </li>
            <li>
            ...
            <li>
              <a target="_blank" href="http://api.jquery.com/category/effects/">
          ...
          <div className="next-rank-description">
            Next rank:{" "}
            <span>
              You are familiar with manipulating the document object model (DOM)
              - modifying values, content, properties, entire elements, etc.
            </span>
          </div>
          <hr />
          <ul className="stats">
      ...
      <div className="skill" data-skill-id={6}>
        ...
        <div className="tool-tip">
          ...
          <div className="skill-description">
            The process of affecting the ranking/visibility of a website or web
            page in a search engines results.
          </div>
          <ul className="skill-links">
            <li>
              <a
            ...
            <li>
              <a target="_blank" href="http://www.google.com/webmasters/tools/">
      ...
      <div className="skill" data-skill-id={8}>
        ...
        <div className="tool-tip">
          ...
          <div className="skill-description">
            JavaScript is the dominant language for client-side programming. It
            executes in the user’s browser to manipulate the HTML document after
            it has loaded. This may be as simple as showing hidden elements, or
          ...
          <ul className="skill-links">
            ...
            <li>
              <a target="_blank" href="http://thenewboston.org/list.php?cat=10">
      ...
      <div className="skill" data-skill-id={9}>
        ...
        <div className="tool-tip">
          ...
          <div className="skill-description">
            ...
            multitude of libraries and frameworks to accomplish common tasks and
          ...
          <div className="next-rank-description">
            Next rank:{" "}
            <span>
              You tap into libraries like jQuery, MooTools, Prototype, Dojo, and
              YUI to streamline your work.
            </span>
          </div>
          <hr />
          <ul className="stats">
      ...
      <div className="skill" data-skill-id={12}>
        ...
        <div className="tool-tip">
          ...
          <div className="skill-description">
            These are software frameworks and collection of packages or modules
            that allow developers to write applications or services without
            having to handle the overhead of common activities and lower level
            details, such as session management, database access, etc.
          </div>
          <ul className="skill-links">
            <li>
              <a
      ...
      <div className="skill" data-skill-id={14}>
        ...
        <div className="tool-tip">
          ...
          <div className="skill-description">
            Besides creating basic tables and relating data, databases allow for
            the creation of stored procedures, sets of SQL statements that are
            stored in the database, and user-defined functions (UDFs) ,
            functions that can be used in SQL statements. Just architecting the
            database is not enough. The database also needs to be optimized or
      ...
      <div className="skill" data-skill-id={16}>
        ...
        <div className="tool-tip">
          <h3 className="skill-name">User Authentication and Authorization</h3>
          <div className="skill-description">
            Authentication is the process determining whether someone or
            something is who or what it is declared to be. Authorization is the
            process of determining if a user is allowed to perform an action or
      ...
      <div className="skill" data-skill-id={17}>
        ...
        <div className="tool-tip">
          ...
          <div className="skill-description">
            ...
            each other in various ways as well as allowing interfaces to be more
            intractive. These include the use of Asynchronous JavaScript and XML
            (AJAX), usually on the client-side, to communicate with an external
            system. Other technologies, such as web services, are used to setup
            end-points for allowing communication with an external system.
          </div>
          <ul className="skill-links">
            <li>
              <a
            ...
            <li>
              <a target="_blank" href="http://thenewboston.org/list.php?cat=61">
      ...
      <div className="skill" data-skill-id={19}>
        ...
        <div className="tool-tip">
          ...
          <div className="skill-description">
            ...
            inviting and easy to understand, by solid use of color, typography,
            balance, hierarchy and white space.
          </div>
          <ul className="skill-links">
            <li>
              <a
      ...
      <div className="skill" data-skill-id={20}>
        ...
        <div className="tool-tip">
          ...
          <div className="skill-description">
            Software such as Photoshop and devices like drawing tablets are used
            to create layouts, work with type, touch-up photos, and other
      ...
      <div className="skill" data-skill-id={22}>
        ...
        <div className="tool-tip">
          ...
          <div className="skill-description">
            You are capable of converting project requirements to an attractive
            design that promotes a pleasant user experience.
          </div>
          <ul className="skill-links"></ul>
          <hr style={{ display: "none" }} />
          <div className="current-rank-description" />
      ...
      <div className="skill" data-skill-id={23}>
        ...
        <div className="tool-tip">
          ...
          <div className="skill-description">
            It is a technique, also known as usability testing, that is used to
            evaluate a website by testing it on users.
          </div>
          <ul className="skill-links">
            <li>
              <a
      ...
      <div className="skill" data-skill-id={25}>
        ...
        <div className="tool-tip">
          ...
          <div className="next-rank-description">
            Next rank:{" "}
            <span>
              You minify your public-facing files and serve compressed files to
              save bandwidth and improve your site's speed.
            </span>
          </div>
          <hr />
          <ul className="stats">
      ...
      <div className="skill" data-skill-id={26}>
        ...
        <div className="tool-tip">
          ...
          <div className="help-message">
            Learn Web Design Mastery, Analytics, Front-end Development Mastery,
            Server-side Development Mastery, User Experience Design Mastery and
            Deployment to unlock.
          </div>
        </div>
        <div className="frame">
          <div className="skill-points">
